<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPerformance.aspx.cs" Inherits="OnlineAssessment.frmPerformance" %>
    ...
    <div>
        <div>
            <ul>
              ...
              <li><a class="active">Overall Performance</a></li>
        ...
        <div id="divRatingReport">
            <asp:GridView ID="grvOverallSkillReport" runat="server" Width="25%" AutoGenerateColumns="false" style="margin-top:3%;" HeaderStyle-BackColor="DodgerBlue" HeaderStyle-ForeColor="White" HorizontalAlign="Center">
            <Columns>
            ...
            <asp:GridView ID="grvSkillReport" runat="server" Width="25%" AutoGenerateColumns="false" style="margin-top:3%;" HeaderStyle-BackColor="DodgerBlue"
        ...
        <div id="divAssignment" style="margin-top:3%;">
                <asp:GridView ID="grvAssignment" runat="server" Width="50%" AutoGenerateColumns="false" HorizontalAlign="Center" HeaderStyle-BackColor="DodgerBlue" HeaderStyle-ForeColor="White">
                <Columns>
                <asp:TemplateField HeaderText="Sl.No" HeaderStyle-Width="2%">
                    <ItemTemplate>
                        <%# Container.DataItemIndex + 1 %>
